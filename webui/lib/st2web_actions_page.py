...
class St2webActionsPage(St2webCommon):
    ...
    def run_action(self, action_name, **kwargs):
        ...
        run_button = actions_page.wait(ImplementationFactory().get_wait_for_element_to_be_clickable(st2web_locators.ACTIONS_RUN_BUTTON))
        run_button.click()
        result = self.st2web.current_view.wait(ImplementationFactory().get_wait_for_element_to_be_present(st2web_locators.ACTIONS_RUN_STATUS))
